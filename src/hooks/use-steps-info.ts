...
export const useStepsInfo = () => {
    ...
    useCopilotReadable({
        ...
        value: `
            ...
            Тебе нужно сразу рассказать основные правила и требования для названия компании. И сразу же предложить ему несколько вариантов используя его email и деятельность бизнеса. Для рекомендации используй action: suggestCompanyNames
        `,
    })
    useCopilotReadable({
